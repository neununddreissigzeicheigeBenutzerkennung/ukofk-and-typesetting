...
\noindent coppy
\smallskip
The controll sequence {\tt\\coppy} coppies the {\it definition} of the {\it controll sequence} in {\tt\#2} and changes the {\it definition} of the {\it controll sequence} in {\tt\#1}.\hfil\break
{\tt\\def\\a\{a\}\hfil\break
\\def\\b\{b\}\hfil\break
\\coppy\\a\\b\hfil\break
\\a} $\rightarrow$ b\hfil\break
Note that  since the {\it definition} is actually copied it stays the same even if the {\it controll sequence} it was copied from is redefined.\hfil\break
...
You can also coppy a {\it controll sequence}'s {\it definition} into itself.\hfil\break
{\tt\\coppy\\a\\a\hfil\break
\\a} $\rightarrow$ d
\medskip
\noindent append
\smallskip
The controll sequence {\tt\\append} appends the{\it definition} of the {\it controll sequence} in {\tt\#2} to the end of the {\it definition} of the {\it controll sequence} in {\tt\#1}.\hfil\break
{\tt\\def\\a\{a\}\hfil\break
\\def\\b\{b\}\hfil\break
\\append\\a\\b\hfil\break
\\a} $\rightarrow$ ab\hfil\break
You can also append a {\it controll sequence}'s {\it definition} to itself.\hfil\break
