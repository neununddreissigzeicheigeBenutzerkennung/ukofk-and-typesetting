...
%
  ...
  \def\item##1{%
    \contextwidth{\bulletwidth}{\lbullet}%
    \showthe\bulletswidth\showthe\bulletwidth%TODO unfortunatly necessary becaus \ifdim won't work otherwise (don't know why please help)
    \ifdim\bulletwidth>\bulletswidth%
      \immediate\bulletswidth\bulletwidth\the\bulletswidth%
    \fi%
    \showthe\bulletswidth%TODO unfortunatly necessary becaus \ifdim won't work otherwise (don't know why please help)
  }%
